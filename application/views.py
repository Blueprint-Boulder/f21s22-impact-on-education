...
from application.forms import ApplicationForm, ScholarshipApplicationForm, VolunteerApplicationForm, \
    CustomizableApplicationForm, InternshipApplicationForm, CollegeApplicationForm
from application.models import Application, VolunteerApplication, ScholarshipApplication, CollegeApplication,\
